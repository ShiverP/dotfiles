...
sudo pacman -S sway swayidle sddm htop brightnessctl xdg-desktop-portal xdg-desktop-portal-wlr pavucontrol swaybg waybar grim alacritty swaylock wofi slurp xorg-xwayland neofetch curl wget stow alsa-tools pulsemixer base-devel fzf zsh neovim solaar steam ttf-font-awesome nerd-fonts --noconfirm
